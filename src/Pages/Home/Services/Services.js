...
const Services = () => {
    return (
        <div className='mt-16'>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 gap-32 px-12'>
                <div className="card w-full bg-white shadow-xl">
                    <figure><img src="https://i.ibb.co/7QWpkJk/48fc724173a5.jpg" alt="Shoes" /></figure>
                    <div className="card-body">
                        <h2 className="card-title text-green-600 font-sans font-bold text-2xl">
                ...
                <div className="card w-full bg-white shadow-xl">
                    ...
                    <div className="card-body">
                        <h2 className="card-title flex justify-center items-center text-amber-500 font-sans font-bold text-2xl">
                            SPA with REACT
                        </h2>
