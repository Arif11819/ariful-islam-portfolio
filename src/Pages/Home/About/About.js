    ...
    return (
        <div className='mt-24 grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2'>
            <div className='grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-5'>
                <div class="card w-96 bg-gradient-to-r from-green-400 to-blue-500 hover:from-pink-500 hover:to-yellow-500 shadow-xl">
                    <div class="card-body">
                        <h2 class="card-title text-7xl font-sans font-bolder pl-28">5+</h2>
                        <p>Months of Experience</p>
                    </div>
                </div>
                <div class="card w-96 bg-gradient-to-r from-green-400 to-green-500 hover:from-green-500 hover:to-red-500 shadow-xl">
                    <div class="card-body">
                        <h2 class="card-title text-7xl font-sans font-bolder pl-28">20+</h2>
                        <p>Complete Projects</p>
                    </div>
                </div>
                <div class="card w-96 bg-gradient-to-r from-green-400 to-blue-500 hover:from-white hover:to-yellow-500 shadow-xl">
                    <div class="card-body">
                        <h2 class="card-title text-7xl font-sans font-bolder pl-28">48+</h2>
                        <p>Working Hours</p>
                    </div>
                </div>
                <div class="card w-96 bg-gradient-to-r from-green-400 to-blue-500 hover:from-pink-500 hover:to-yellow-500 shadow-xl">
                    <div class="card-body">
                        <h2 class="card-title text-7xl font-sans font-bolder pl-28">1+</h2>
